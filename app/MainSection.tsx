...
export default function MainSection ({ isOpen }: { isOpen: boolean })  {
    ...
    // Ganti gambar tiap 10 detik
    useEffect(() => {
        const interval = setInterval(() => {
            setCurrentImage((prev) => (prev + 1) % imageCouple.length);
        }, 10000);
...
<div className="relative">
  <div className="w-60 h-84 bg-gray-300 rounded-t-full rounded-b-lg overflow-hidden border-[8px] border-sky-200 mx-auto relative">
    <AnimatePresence mode="wait">
      <motion.img
        key={imageCouple[currentImage]}
        src={`/assets/images/couple/${imageCouple[currentImage]}`}
        alt="Gallery"
      ...
      />
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-start py-10 px-4">
                    ...
                    <div className="flex gap-4 animate-marquee">
                        {[...messages, ...messages, ...messages].map((msg, i) => (
                            ...
                            >
                                ...
                                <p className="text-gray-700 whitespace-pre-line leading-relaxed mb-2">{msg.message}</p>
                ...
                >
                    <h2 className="text-lg font-semibold text-sky-800 mb-1 text-center">Tulis Ucapan Kamu ✍️</h2>
                    <input
                        type="text"
            ...
            >
                ...
                <p className="text-sm opacity-80">© 2025 {couple.man.alias} & {couple.woman.alias} Wedding</p>
            </motion.section>
        </main>
    )
}